...
def run_regret_experiment_pytorch( dataset, 
  ...
  for i in range(baseline_steps):
    ...
    if i ==0:
      ...
      #model_biased.initialize_theta(batch_X)
      #optimizer_model = torch.optim.Adam([model.theta], lr=0.01)
           
      optimizer_baseline = torch.optim.SGD(baseline_model.network.parameters(), lr = 0.01)


    # print("before optimization")
    # for parameter in baseline_model.network.parameters():
...
# def run_regret_experiment( dataset, 
#     logging_frequency, 
#     max_num_steps, 
#     logistic_learning_rate, 
#     threshold, 
